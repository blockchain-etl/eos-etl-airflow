...
from eosetl_airflow.build_verify_streaming_dag import build_verify_streaming_dag
from eosetl_airflow.variables import read_verify_streaming_dag_vars
...
DAG = build_verify_streaming_dag(
    dag_id='eos_verify_streaming_dag',
