...
def read_export_dag_vars(var_prefix, **kwargs):
    ...
    if export_max_active_runs is not None:
        export_max_active_runs = int(export_max_active_runs)
    ...
    vars = {
        ...
        'provider_uris_shuffle': parse_bool(read_var('provider_uris_shuffle', var_prefix, False, **kwargs), default=False),
